...
LOCAL_APPS = [
    ...
    'simpleblog.users.apps.UsersConfig',
    'simpleblog.authentication.apps.AuthenticationConfig',
]
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='psql://sim:sim@127.0.0.1:5432/simpleblog'),
}
